...
aft_est <- surv_fit$coefficients 
aft_se <- summary(surv_fit)$table[, "Std. Error"] 
sAFT_vars <- c("beta_long[1]", "beta_long[2]", "beta_long[3]", "beta_surv[1]", "alpha_tilde") 
sAFT_draws <- posterior::as_draws_df(sAFT_fit$draws(variables = sAFT_vars)) 
...
result_comparison <- data.frame(Parameter = c("beta_long_intercept", "beta_long_time", "beta_long_time_arm", "beta_surv_arm", "alpha_tilde"), 
                    ...
                    AFT = c(NA, NA, NA, aft_est["arm"], NA), 
                    AFT_SE = c(NA, NA, NA, aft_se["arm"], NA), 
                    AFT_L95 = c(NA, NA, NA, aft_est["arm"] - 1.96*aft_se["arm"], NA), 
                    AFT_U95 = c(NA, NA, NA, aft_est["arm"] + 1.96*aft_se["arm"], NA), 
                    sAFT = c(sAFT_est["beta_long[1]"], sAFT_est["beta_long[2]"], sAFT_est["beta_long[3]"], sAFT_est["beta_surv[1]"], sAFT_est["alpha_tilde"]), 
                    sAFT_SE = c(sAFT_se["beta_long[1]"], sAFT_se["beta_long[2]"], sAFT_se["beta_long[3]"], sAFT_se["beta_surv[1]"], sAFT_se["alpha_tilde"]), 
                    sAFT_L95 = c(sAFT_l95["beta_long[1]"], sAFT_l95["beta_long[2]"], sAFT_l95["beta_long[3]"], sAFT_l95["beta_surv[1]"], sAFT_l95["alpha_tilde"]), 
                    sAFT_U95 = c(sAFT_u95["beta_long[1]"], sAFT_u95["beta_long[2]"], sAFT_u95["beta_long[3]"], sAFT_u95["beta_surv[1]"], sAFT_u95["alpha_tilde"])) 
result_comparison
